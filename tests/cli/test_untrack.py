...
def test_untrack_cli_rejects_removal_that_exposes_singleton_dependency_profile_ambiguity(
    tmp_path: Path,
    monkeypatch,
    capsys,
) -> None:
    ...
    assert exit_code == 2
    assert "ambiguous implicit profile contexts for fixture:shared" in capsys.readouterr().err
